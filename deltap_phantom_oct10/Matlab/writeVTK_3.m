function [] = writeVTK_3(vol,vtkfile, header)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% pixel spacing
spX = header.PixelSpacing(1)/1000;
spY = header.PixelSpacing(2)/1000;
spZ = header.SliceThickness/1000;

% origin
oX = header.ImagePositionPatient(1)/1000;
oY = header.ImagePositionPatient(2)/1000;
oZ = header.ImagePositionPatient(3)/1000;
