% This script is meant to find the powers of the Visualase patients.
...
[Power_intervals , times] = power_parser_write_DF(power_log);
csvwrite ('Powers_DF.csv' , Power_intervals);
csvwrite ('Times_DF.csv' ,  times);
