...
elseif choice ==4
    ...
    load ('long_diss_ArrDose22');  % good one, agrees w/long_diss_ArrDose
...
if choice ==5 ||choice==4
    ...
    LOOCV_mean_postDSC = LOOCV_mean_post;
    LOOCV_median_postDSC = LOOCV_mean_post;
    naive_passDSC = LOOCV_mean_post;
    best_eyeball_normDSC= LOOCV_mean_post;
    eyeball_norm20DSC = LOOCV_mean_post;
    no_global_LOOCVDSC = LOOCV_mean_post;
    LOOCV_mean_postL2 = LOOCV_mean_post;
    LOOCV_median_postL2 = LOOCV_mean_post;
    naive_passL2 = LOOCV_mean_post;
    best_eyeball_normL2= LOOCV_mean_post;
    eyeball_norm20L2 = LOOCV_mean_post;
    no_global_LOOCVL2 = LOOCV_mean_post;
    ...
    for jj = 1:length(index)
        ...
        LOOCV_median_postDSC(ii) = total{ii,3}(median_spot,7);
        naive_passDSC(ii) = total{ii,3}(naive_ix,7);
        best_eyeball_normDSC(ii)= total{ii,3}(eyeball_ix,7);
    ...
    %DSC stats
    LOOCV_mean_post_statsDSC = Descriptive_statistics_LOOCV(LOOCV_mean_postDSC);
    LOOCV_median_post_statsDSC= Descriptive_statistics_LOOCV(LOOCV_median_postDSC);
    naive_statsDSC = Descriptive_statistics_LOOCV(naive_passDSC);
    best_eyeball_statsDSC = Descriptive_statistics_LOOCV(best_eyeball_normDSC);
    eyeball_stat20DSC=Descriptive_statistics_LOOCV(eyeball_norm20DSC);
...
prctile(LOOCV_mean_post,[0 25 50 75 100])
