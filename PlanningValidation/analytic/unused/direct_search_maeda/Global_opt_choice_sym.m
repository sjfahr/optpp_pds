...
function Global_opt_choice_sym (choice);
...
if choice == 1
    ...
    save ('all_opt_mu.mat','all_opt_fig','no_pwr_fig','sim_dim','summary');
    
elseif choice == 2
    
    save ('all_opt_perf.mat','all_opt_fig','no_pwr_fig','sim_dim','summary');
    
elseif choice == 3
    
    save ('all_opt_cond.mat','all_opt_fig','no_pwr_fig','sim_dim','summary');
...
for ii = 2:(num_studies+1)
    ...
    [ total{ii,2}, total{ii,3}, total{ii,4}, total{ii,5}, total{ii,6} ] = metric_calculator ( MRTI_crop, MRTI_isotherm, MRTI_list,n_MRTI,model_crop,inputdatavars );
