...
function [total, dice, hd] = temperature_obj_fxn_GPU22 ( inputdatavars, sources, mu_eff_list );
...
%w_perf = linspace ( 0, 30,31);
k_cond = linspace ( 0.01,2,200);

[tmap_unique] = Human_GPU_cond ( power_log,spacing,scaling,mod_point,source,w_perf,k_cond,g_anisotropy,mu_eff_list,probe_u,robin_co,c_blood);
