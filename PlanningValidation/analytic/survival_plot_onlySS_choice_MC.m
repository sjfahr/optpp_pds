%
function [] = survival_plot_onlySS_choice_MC (dice_values, naive_values, dice_opt,naive_tag);
...
figure; h_title = title( 'DSC performance during LOOCV versus literature'); hold all;
